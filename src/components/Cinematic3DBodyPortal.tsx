      ...
      (gltf) => {
        ...
        model.traverse((child) => {
          if ((child as THREE.Mesh).isMesh) {
            ...
            // Map organ meshes for active animation and raycasting
            if (mesh.name.includes('Organ_Thyroid')) organMeshes['thyroid'] = mesh;
            if (mesh.name.includes('Organ_Stomach')) organMeshes['stomach'] = mesh;
            if (mesh.name.includes('Organ_Liver')) organMeshes['liver'] = mesh;
            if (mesh.name.includes('Organ_Heart')) organMeshes['heart'] = mesh;
            if (mesh.name.includes('Organ_Brain')) organMeshes['brain'] = mesh;
            if (mesh.name.includes('Organ_Kidney')) organMeshes['kidneys'] = mesh;

            // Handle translucent X-Ray skin
            if (mesh.name.includes('Anatomy_')) {
